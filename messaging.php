...
$ctlr = new MessageController();
$res = NULL;
if (isset($_POST['submit'])) {
    $res = $ctlr->save_buyer_message($_POST, $buyer, $seller);
}
$result = $ctlr->select_seller_message($buyer, $seller);
?>
<html>
    <head>
                ...
                <div class="inbox_msg">
                    <div class="headind_srch">
                        <div class="recent_heading">
                            <h4>
                                <?php
                                $sql = "SELECT name FROM user where id='$seller'";
                        ...
                        <div class="srch_bar">
                            <div class="stylish-input-group">
                                <div class="recent_heading" style="align-content: right;width: 100%;">
                                    <h4>Me</h4>
                                    <a href="messaging.php?buyer=<?php echo $buyer; ?>&seller=<?php echo $seller; ?>">
